        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button
              ...
              className="group px-8 py-4 bg-gradient-to-r from-emerald-500 to-blue-600 hover:from-emerald-600 hover:to-blue-700 rounded-2xl hover:shadow-2xl flex items-center space-x-2"
              size="lg"
            >
            ...
            <Button
              variant="outline"
              className="px-8 py-4 bg-white/10 backdrop-blur-sm text-white border-white/20 hover:bg-white/20 rounded-2xl"
              size="lg"
            >
              Watch Demo
            </Button>
